...
results_files = [
    r'D:\123\123main\runs\exp (_init_)\results.csv',
    r'D:\123\123main\runs\exp1 (other)\results(shufflnet).csv',
    r'D:\123\123main\runs\exp1 (other)\results(ShuffleNetV2+C3Ghost).csv',
]
...
custom_labels = [
    'YOLOv8s',
    'YOLOv8s-ShuffleNetV2',
    'YOLOv8s-ShuffleNetV2+C3Ghost',
]

# PR 和 F1 曲線文件路徑（for F1、PR曲線）
f1_csv_dict= {
    'YOLOv8s':r'D:\123\123main\runs\exp (F1 _init_)\F1_curve.csv',
    'YOLOv8s-ShuffleNetV2':r'D:\123\123main\runs\exp1 (F1 other)\F1_curve (ShuffleNetV2).csv',
    'YOLOv8s-ShuffleNetV2+C3Ghost':r'D:\123\123main\runs\exp1 (F1 other)\F1_curve (ShuffleNetV2+C3Ghost).csv',
}

pr_csv_dict = {
    'YOLOv8s':r'D:\123\123main\runs\exp (PR  _init_)\PR_curve.csv',
    'YOLOv8s-ShuffleNetV2':r'D:\123\123main\runs\exp1 (PR other)\PR_curve(shufflnet).csv',
    'YOLOv8s-ShuffleNetV2+C3Ghost':r'D:\123\123main\runs\exp1 (PR other)\PR_curve(ShuffleNetV2+C3Ghost).csv',
}
